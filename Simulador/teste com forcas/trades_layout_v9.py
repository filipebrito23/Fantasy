...
view = st.sidebar.radio("Visão", ["Resumo", "Ranking", "Elenco", "Banco", "Cenários", "Matchups", "Sugestão de troca"])
...
if view == "Resumo":
    ...
    if matrix.empty:
        ...
        fig = px.imshow(matrix.astype(float), text_auto=True, aspect="auto", color_continuous_scale="Blues", title="Matriz de confrontos")
