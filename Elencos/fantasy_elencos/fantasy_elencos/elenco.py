...
st.caption("Etapa 4 v4: desenvolvimento com seletor de temporada, salários por ano e cap da development.")
...
st.info("Development usa cap de 14.000.000 - salários por temporada.")
