...
st.markdown(display_main.to_html(escape=False, index=False), unsafe_allow_html=True)
...
st.markdown(display_dev.to_html(escape=False, index=False), unsafe_allow_html=True)
